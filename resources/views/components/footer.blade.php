<footer class="mt-16 border-t border-brand-100 bg-brand-50">
    <div class="mx-auto grid w-full max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-3 lg:px-8">
        <div>
            ...
            <p class="mt-3 text-sm text-gray-700">Pastoor Sandersstraat 28, 7131 BV Lichtenvoorde</p>
        </div>
    ...
    <div class="border-t border-brand-100">
        <div class="mx-auto flex w-full max-w-6xl items-center justify-between px-4 py-4 text-sm text-gray-700 sm:px-6 lg:px-8">
