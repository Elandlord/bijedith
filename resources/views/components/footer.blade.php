<footer class="mt-16 border-t border-brand-100 bg-brand-50">
    <div class="mx-auto grid w-full max-w-6xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-3 lg:px-8">
        <div>
            <a class="text-2xl font-display font-semibold text-bijedith-black" href="{{ route('home') . '#home' }}">Bij Edith</a>
        ...
        <div>
            ...
            <ul class="mt-4 space-y-2 text-sm text-gray-600">
                ...
                <li><a class="transition hover:text-brand-700" href="{{ route('home') . '#pedicurebehandelingen' }}">Pedicurebehandelingen</a></li>
