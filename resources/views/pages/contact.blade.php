    ...
    <section class="px-4 pb-16 sm:px-6 lg:px-8">
        <div class="mx-auto grid w-full max-w-6xl gap-8 lg:grid-cols-2">
            <div class="rounded-3xl border border-brand-100 bg-white p-6 shadow-sm lg:p-10">
                ...
                <p class="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm leading-relaxed text-amber-800">De salon heeft geen ruimte voor nieuwe vaste klanten. Voor een korte incidentele behandeling kunt u een afspraak plannen middels het online boekingsysteem.</p>
