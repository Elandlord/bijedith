...
@section('content')
    @include('components.page-header', [
        ...
        'subtitle' => 'Maak een afspraak via de boekingsknop rechtsonder, of neem contact op via onderstaande gegevens.',
    ])
            ...
            <div class="rounded-3xl border border-brand-100 bg-white p-6 shadow-sm lg:p-10">
                ...
                <dl class="mt-6 space-y-4 text-sm text-gray-600">
                    <div>
                        ...
                        <dd class="mt-1">Rapenburgsestraat 38<br>7131 CW Lichtenvoorde</dd>
                    </div>
                    <div>
