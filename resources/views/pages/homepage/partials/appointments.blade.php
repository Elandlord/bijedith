...
{{--                <a class="btn btn-round bg-bijedith-gray text-bijedith-black hover:bg-bijedith-dark-gray mt-4 ml-2 sm:mt-0 sm:ml-0" style="" href="tel:0544-373326">--}}
{{--                    Of bel: 0544-373326--}}
{{--                </a>--}}
{{--            </form>--}}
            <h2 class="text-4xl py-12">Pedicure & Spa Bij Edith is volgeboekt</h2>
            <p>Daardoor hebben we tot nader bericht een tijdelijke cliëntenstop.</p>
        </div>
    </div>
</section>
